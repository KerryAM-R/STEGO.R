                               ...
                               downloadSeurat = F, csv_contig_file = "csv", main_directory = "0_RAW_files/")
{
  ...
  for (i in 2:num) {
    ...
    if (downloadClusTCR) {
      ...
      if (nrow(TRAG) > 0) {
        file_name_clust <- paste0("1_ClusTCR/", "AG_",
                                  sub_directory, "_clusTCR_10x_", today(), ".csv")
    ...
    if (downloadSeurat) {
      ...
      file_name_md <- paste0("1_SeuratQC/", sub_directory,
                             "_metadata_10x_", today(), ".csv")
      ...
      file_name_mat <- paste0("1_SeuratQC/", sub_directory,
                              "_count-matrix_10x_", today(), ".csv.gz")
    ...
    if (downloadTCR_Explore) {
      ...
      file_name_tcrexplore <- paste0("1_TCR_Explore/",
                                     sub_directory, "_TCR_Explore_10x_", today(),
                                     ".csv")
